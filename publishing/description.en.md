...
## [color=#ff6666]How to use[/color]

[color=#ff6666]Enable the mod, close the original inventory and enter /mortisbuffs in chat. The Mortis page is available in all three reward modes. Before starting, choose a mode and switch the native and DIY pools on or off independently. Open Package manager to inspect automatically loaded packages, refresh new packages or export a starter package.[/color]
